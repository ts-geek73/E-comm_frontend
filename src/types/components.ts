...
export interface ProductCardProps {
  ...
  onAddToCart?: (product: IProductData) => Promise<void>;
  onWishlistToggle?: (
...
export interface ICartItemComp {
  cartdata: ICartresponce;
  itemsBeingUpdated: Set<string>;
  handleQuantityChange: (productId: string, change: number) => Promise<void>;
  handleRemoveItem: (productId: string) => Promise<void>;
  rupeeSymbol: string;
  products: IProductData[];
  handleComplementaryAddToCart: (product: IProductData) => Promise<void>;
