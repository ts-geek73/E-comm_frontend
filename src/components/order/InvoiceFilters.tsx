...
export const InvoiceFiltersComponent = ({
  invoiceFilters,
  ...
  <Card className="mb-6">
    <CardContent className="p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <Button variant="outline" size="sm" onClick={clearInvoiceFilters}>
          Clear All
        </Button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              handleInvoiceFilterChange("sortBy", value)
            }
          >
            <SelectTrigger>
              <SelectValue />
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              handleInvoiceFilterChange("sortOrder", value as "asc" | "desc")
            }
          >
            <SelectTrigger>
              <SelectValue />
