import { IImageUrlWithFile, ReviewImageGridProps } from "@types";
import { X } from "lucide-react";
import Image from "next/image";
import { useState } from "react";
import PaginationComp from "../Product/PaginationComp";

const ReviewImageGrid: React.FC<ReviewImageGridProps> = ({
  images,
  onRemove,
  editable = false,
}) => {
    ...
    <div className="space-y-3">
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {currentImages.map((img: IImageUrlWithFile, index: number) => (
          ...
          >
            <div className="aspect-square cursor-pointer overflow-hidden bg-gray-100">
              <Image
                src={img.url}
