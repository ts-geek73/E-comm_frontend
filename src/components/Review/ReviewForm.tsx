...
import { ReviewImageGrid } from "@components/Review";
import { Button } from "@components/ui/button";
import { IImageUrlWithFile, ProductFormProps } from "@types";
    ...
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
      ...
      <div className="mb-6">
        ...
        <textarea
          ...
          onChange={(e) =>
            setUpdatedReview({ ...updatedReview, description: e.target.value })
          }
