    ...
    <div className="p-6 md:p-8 flex flex-col">
      <div className="flex justify-between items-start">
        <div>
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mt-2 mb-1">
            {product.name}
          </h1>
          ...
          <p className="text-gray-500 text-sm mb-2">
            ...
            <span className="font-medium text-gray-700">
              {product.brands.map((brand) => brand.name) ?? "unknown"}
            </span>
          </p>
        </div>
      ...
      <div className="mt-auto">
        ...
        <div className="flex flex-col gap-2 mb-6 bg-gray-50 p-3 rounded-lg">
          <div className="flex items-center text-sm">
            ...
            <span>
              <span className="font-medium">Free delivery</span> within 2-5
              business days
            </span>
          </div>
          <div className="flex items-center text-sm">
            ...
            <span>
              <span className="font-medium">1 Year warranty</span> on all
              products
            </span>
          </div>
        </div>
