...
export const renderDataTable = (tableData: RowData[], title: string) => {
    ...
    const fieldsToShow = expectedFields.filter(field => availableFields.includes(field));
    const otherFields = availableFields.filter(field => !expectedFields.includes(field));
...
export const expectedFields = [
    ...
    'segment', 'length_mm', 'width_mm', 'height_mm', 'car_body_type', 'source_url'
];