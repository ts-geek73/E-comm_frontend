import { formatDate } from "@/components/Functions/product"
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-600">
                            {stockEntries.length} {stockEntries.length === 1 ? 'entry' : 'entries'} found
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <TableRow>
                            <TableCell colSpan={6} className="text-center py-12">
                                <div className="flex flex-col items-center gap-3 text-gray-500">
                                    ...
                                    <div>
                                        <p className="text-lg font-medium text-gray-700">No stock entries found</p>
                                        <p className="text-sm text-gray-500">Add your first stock entry to get started</p>
                                    </div>
                                </div>
                            </TableCell>
                        </TableRow>
                                ...
                                <TableCell>
                                    {entry.description ? (
                                        ...
                                        <div className="flex items-center gap-2 text-gray-400">
                                            ...
                                            <span className="text-sm italic">No description available</span>
                                        </div>
                                    )}
                                </TableCell>
